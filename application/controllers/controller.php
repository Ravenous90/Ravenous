...
class Controller
{
    ...
    { // получение данных с полей входа и запись их в переменные
        if (isset($_POST['username'])) {
            $username = $_POST['username'];
            if ($username == '') {
                unset($username);
    ...
    function getDataAccount($username, $email, $old_password, $new_password, $gender, $age, $phone, $info)
    { // получение данных с полей редактировани профиля и запись их в переменные
        if (isset($_POST['username'])) {
            $username = $_POST['username'];
            if ($username == '') {
                unset($username);
