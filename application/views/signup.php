		...
		<div class="signup">
			<h3 class="create_account">Create account:</h3>
				<form method="post" action="../controllers/work_signup.php" name="signup" id="signup">
					<p><strong>Username: <input name="username" type="text" class="field" placeholder="Enter your username"></strong></p>
					<p><strong>E-mail: <input name="email" type="text" class="field" placeholder="Enter your E-mail"></strong></p>
					<p><strong>Password: <input name="password" type="password" class="field" placeholder="Enter your password"></strong></p>
