...
<div class="account" id="account_block">
    <h3 class="account_room">Your have entered to site as <?= $_SESSION['username'] ?> <input type="submit"
                                                                                              value="Edit profile"
                                                                                              id="edit_profile"></h3>
    <div style="display: none;">
        <div class="box-modal" id="modal">
            <form method="post" action="" id="change">
                <p>Username: <input name="username" type="text" class="field_account" placeholder="Change username"
                                    value="<?= $_SESSION['username'] ?>"</p>
                <p>E-mail: <input name="email" type="email" class="field_account" value="<?= $_SESSION['email'] ?>"
                                  readonly></p>
                <p><input name="password" type="hidden" class="field_account" value="<?= $_SESSION['password'] ?>"
                          readonly></p>
                <p>Old password: <input name="old_password" type="password" class="field_account"
                                        placeholder="Enter password"></p>
                <p>New password: <input name="new_password" type="password" class="field_account"
                                        placeholder="Change password"></p>
                ...
                <p>Age: <input name="age" type="text" class="field_account" value="<?= $_SESSION['age'] ?>"
                               placeholder="Add age"></p>
                <p>Phone: <input name="phone" type="text" class="field_account" value="<?= $_SESSION['phone'] ?>"
                                 placeholder="Add phone"></p>
                <p>Info: <input name="info" type="textarea" class="field_account" value="<?= $_SESSION['info'] ?>"
                                placeholder="Add info about yourself"></p>
